...
class TestPurchaseOrdersAPI:
    ...
    def test_add_po_item(self, auth_client, sample_purchase_order, sample_product, app):
    ...
    def test_delete_purchase_order(self, auth_client, sample_purchase_order, app):
